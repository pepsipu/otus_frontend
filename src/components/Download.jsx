...
export default class Download extends Component{
    render() {
        return <div>
            <p>So, you want to make an image using the Otus Engine? Well, you've come to the right place! Check out the tutorial on <a href={"https://www.youtube.com/watch?v=-Kc20wS_L6E"}>youtube</a>.</p>
